...
get_mer_id(PaymentType) when is_atom(PaymentType) ->
  up_config_svr:get_mer_id(PaymentType).

get_mer_id_default(PaymentType) when is_atom(PaymentType) ->
  up_config_svr:get_mer_id_default(PaymentType).
...
get_mer_prop(MerId, Key) when is_atom(MerId),
  ...
  ->
  up_config_svr:get_mer_prop(MerId, Key).

%%--------------------------------------------------------------------
get_config(Key) when is_atom(Key) ->
  up_config_svr:get_config(Key).
...
check_payment_method(PaymentType, BankIdBin, CardNo) when is_atom(PaymentType) ->
  up_config_svr:check_payment_method(PaymentType, BankIdBin, CardNo).

%%--------------------------------------------------------------------
get_mer_list() ->
  up_config_svr:get_all_mer().

%%--------------------------------------------------------------------
get_mer_id_map() ->
  up_config_svr:get_mer_id_map().
